...
def create_example_dir(example_dir_path):
...
def initialize_example_dir(example_dir_path):
    create_example_dir(example_dir_path)
...
def extract_all_examples():
    ...
    initialize_example_dir(config.example_dir)  # Doesn't erase
    create_example_dir(config.java11_dir)
